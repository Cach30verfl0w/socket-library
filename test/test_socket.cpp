...
TEST(sockslib_Socket, test_connect_tcp_socket) {
    auto server_socket_result = kstd::try_construct<sockslib::Socket>(1337, sockslib::SocketType::TCP, 512);
    server_socket_result.throw_if_error();

    auto socket_result = kstd::try_construct<sockslib::Socket>("127.0.0.1", 1337, sockslib::SocketType::TCP, 512);
    socket_result.throw_if_error();
}

TEST(sockslib_Socket, test_connect_udp_socket) {
    auto server_socket_result = kstd::try_construct<sockslib::Socket>(1337, sockslib::SocketType::UDP, 512);
    server_socket_result.throw_if_error();

    auto socket_result = kstd::try_construct<sockslib::Socket>("127.0.0.1", 1337, sockslib::SocketType::UDP, 512);
    socket_result.throw_if_error();
}
